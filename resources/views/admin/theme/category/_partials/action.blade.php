...
<a title="Edit" class="btn btn-outline-primary" href="{{ route('admin.theme.edit_category',$category->id) }}">
    <i class='far fa-edit'></i>
</a>
<button title="Delete" onclick="OpenCategoryDeleteBox({{ $category->id }})" class="btn btn-outline-danger">

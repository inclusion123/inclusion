<a title="Edit" class="btn btn-outline-success" href="{{ route('admin.projects.index', $row->id) }}">
   Projects
</a>

<a title="Edit" class="btn btn-outline-primary" href="{{ route('admin.projectcategory.edit', $row->id) }}">

                    ...
                    <form action="{{ route('admin.service.store') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" class="form-control" name="desc" rows="3" placeholder="Enter ..."
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote2" class="form-control" name="detail_description" rows="3" placeholder="Enter ..."
                                    value="{{ old('detail_description') }}"required></textarea>

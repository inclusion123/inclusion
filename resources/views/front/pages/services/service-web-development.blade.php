    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                ...
                <a href="{{ route('front.service.web_development') }}" class="h5 text-white">Web Development</a>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Web App Development Solutions </h5>
            ...
            <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam amet
                diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Cross Platform Web App Development </h5>
                <h1 class="mb-0">Magna sea eos sit dolor, ipsum amet lorem diam dolor eos et diam dolor</h1>
            </div>
            ...
            <div class="row g-5 mt-5 mb-5">
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/vue.png">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 mt-5 mb-5">
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/angular.png">
                    </div>
                </div>
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="experties-cnt">
                        <h3 class="mb-3">AngularJS</h3>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit.
                            Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem
                            sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet
                            Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam amet diam et
            ...
            <div class="row g-5 mt-5 mb-5">
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/typescript.png">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 mt-5 mb-5">
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/php_PNG3.png">
                    </div>
                </div>
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="experties-cnt">
            ...
            <div class="row g-5 mt-5 mb-5">
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/python.png">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 mt-5 mb-5">
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/laravel.png">
                    </div>
                </div>
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="experties-cnt">
            ...
            <div class="row g-5 mt-5 mb-5">
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="experties-img">
                        <img src="img/services-icons/nodejs.png">
                    </div>
                </div>
            </div>
        </div>

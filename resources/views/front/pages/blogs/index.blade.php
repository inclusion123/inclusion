                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <a href="{{route('front.blog_detail',['s'=> $blog->slug])}}"><img class="img-fluid" src="{{ asset('front/img/blog-1.jpg') }}" alt=""></a>
                                ...
                                <div class="p-4">
                                    ...
                                    <a class="text-uppercase" href="{{route('front.blog_detail',['s'=> $blog->slug])}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach

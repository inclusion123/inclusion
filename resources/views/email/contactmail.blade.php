                            ...
                            <tr>
                                <td style="padding: 0; text-align: center;">
                                    <a href="#" style="color: #348eda;" target="_blank">
                                        <img src="{{ asset('front\img\logo.png') }}" alt="Bootdey.com"
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF"
                    ...
                    <table width="100%"
                        ...
                        <tbody>
                            <tr>
                                <td>Name: <h1>{{ $data['name'] }}</h1></td>
                                <td>Email: <p>{{ $data['email'] }}</p></td></td>
                                <td>Subject: <h2>{{ $data['subject'] }} </h2></td>
                                    ...
                                    <table cellspacing="0" style="border-collapse: collapse; margin-bottom: 40px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="right" style="padding: 5px 0;">Free plan (10,000 msg/month)
                                                </td>
                                            </tr>
                                            <tr>
